...
<div class="page-header">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card">
        <div class="card-body">
          <h6 class="mb-2 f-w-400 text-muted">Total Divisi</h6>
          <h4 class="mb-3">42,236 <span class="badge bg-light-primary border border-primary"><i
                class="ti ti-folders"></i> 59.3%</span></h4>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-xl-3">
      <div class="card">
        <div class="card-body">
          <h6 class="mb-2 f-w-400 text-muted">Total Teacher</h6>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card">
        <div class="card-body">
          <h6 class="mb-2 f-w-400 text-muted">Total Student</h6>
    ...
    <div class="col-md-6 col-xl-3">
      <div class="card">
        <div class="card-body">
          <h6 class="mb-2 f-w-400 text-muted">Total Task</h6>
